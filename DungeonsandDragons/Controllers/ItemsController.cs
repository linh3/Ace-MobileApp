...
namespace DungeonsandDragons.Controllers
{
    ...
    public class ItemsController
    {
        ...
        public async void GetItemsFromServer(int parameter = 1)
        {
            ...
            // URL for the Server
            var URLComponent = "GetItemList/1";
        ...
        public async Task<List<Item>> GetItemsFromDungeonsandDragons(int number, int level, AttributeEnum attribute, ItemLocationEnum location, bool random, bool updateDataBase)
        {
            // Needs to get items from the server
            // Parse them
            // Then update the database
